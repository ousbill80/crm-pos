...
export const P2P_ROLES = {
  ...
  rapprochement: [RoleLibelle.RAF_COMPTABLE, RoleLibelle.DAF],
  ...
  comptabiliteEcriture: [RoleLibelle.RAF_COMPTABLE, RoleLibelle.DAF],
  immoDotation: [RoleLibelle.RAF_COMPTABLE, RoleLibelle.DAF],
  paiementApprobation: [RoleLibelle.DAF],
  paiementException: [RoleLibelle.DIRECTION_GENERALE, RoleLibelle.DAF],
  ...
  aiReview: [RoleLibelle.RAF_COMPTABLE, RoleLibelle.DAF],
